...
const ServiceSchema = Joi.object({
    name:Joi.string().min(2).max(50).trim().label("Service Name").messages({
        ...
        "string.min":"Service name must be at least 2 character long",
        ...
        "string.max":"Description must not exceed 500 character",
        ...
        "string.base":"Category must be valid ID",
...
export const updateServiceSchema = ServiceSchema.form(
    ...
    "object.missing":"name, price, duration, description, category or isActive any of these fields of required when updating"
})
